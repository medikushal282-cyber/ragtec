...
with open('C:/Projects/RAGTEC/phase_01_report.md', 'r') as f:
    report = f.read()

with open('C:/Projects/RAGTEC/architecture_gap_audit.md', 'r') as f:
    audit = f.read()

body = f"""Here is the completion report for Phase 1, along with the updated architecture gap audit.

# 1. phase_01_report.md
Path: C:\\Projects\\RAGTEC\\phase_01_report.md
